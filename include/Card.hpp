...
public:
  ...
  Card(std::string id, std::string name, Rarity rarity, int sellValue,
...
public:
  CreatureCard(std::string id, std::string name, Rarity rarity, int sellValue,
               std::string description, int attackPower,
...
public:
  SpellCard(std::string id, std::string name, Rarity rarity, int sellValue,
            std::string description, int manaCost, std::string imagePath = "");
...
public:
  RelicCard(std::string id, std::string name, Rarity rarity, int sellValue,
            std::string description, int durability,
            std::string imagePath = "");
